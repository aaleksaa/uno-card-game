...
/**
 * The ActionCard class represents a "Skip", "Reverse" and "Draw two" cards in Uno card game.
 * It extends the Card class and includes specific behavior for action cards.
 */
public class ActionCard extends Card {
    /**
     * Constructs an ActionCard with the specified color and card type.
     *
     ...
     * Two ActionCards are considered equal if they have the same color and card type.
     *
